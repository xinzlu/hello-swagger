...
import (
	...
	"github.com/xinzlu/hello-swagger/models"
	"github.com/xinzlu/hello-swagger/restapi/operations"
)

//go:generate swagger generate server --target .. --name Hello --spec ../swagger/swagger.yml
